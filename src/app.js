            ...
            <div>
                    ...
                    <Modal visible={this.state.visible} onClose={this.hide.bind(this)}>
                           <div className="header">Modal</div>
                            <div className="body">这个是一个modal组件</div>
                            <button className="confirm-btn" onClick={this.hide.bind(this)}>确定</button>
                            <button className="cancel-btn" onClick={this.hide.bind(this)}>取消</button>
                    </Modal>
        </div>
        </div>
